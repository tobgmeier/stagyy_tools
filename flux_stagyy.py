...
parser.add_argument('--flux_daymelt', dest='flux_daymelt', help="If true, dayside is plotted on W/m^2 and nightside on mW/m^2",default=False, action='store_true')
parser.add_argument('--fllux_all_solid', dest='flux_all_solid', help="If true, dayside and nightside are on mW/m^2",default=False, action='store_true')
